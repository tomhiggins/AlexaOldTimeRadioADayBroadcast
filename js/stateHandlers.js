...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = 'Welcome to the Old Time Radio Broadcasts for this day in history. You can say, play the audio to begin the broadcast.';
        ...
        'AMAZON.HelpIntent' : function () {
            var message = 'Welcome to the Old Time Radio Broadcasts for this day in history. You can say, play the audio, to begin the broadcasts.';
            this.response.speak(message).listen(message);
            this.emit(':responseReady');
        },
        'AMAZON.StopIntent' : function () {
            var message = 'Excelsior.';
            this.response.speak(message);
            this.emit(':responseReady');
        },
        'AMAZON.CancelIntent' : function () {
            var message = 'Duffys Tavern. Duffy aint here.';
            this.response.speak(message);
            this.emit(':responseReady');
        },
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the Old Time Radio Broadcasts for this day in history. You can say, play the audio to begin the broadcasts.';
        ...
        'PlayBroadcast' : function () { controller.play.call(this) },
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to the Old Time Radio Broadcasts for this day in history. You can say, Next or Previous to navigate through the playlist. ' +
